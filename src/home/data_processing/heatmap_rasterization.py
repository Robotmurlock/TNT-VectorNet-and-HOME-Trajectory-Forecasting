"""
Heatmap rasterization pipeline

Rasterized data can be few times bigger than in vectorized format (sparse matrices/images) and
data processing is mostly used in `online` format
"""
import logging
import os
...
from library.utils import image_processing, time
